...
//     const newRecord = {
//       ipAddress: formData.ipAddress, // Changed from 'ip'
//       purposeOfUse: formData.purposeOfUse || "Application Server", // Changed from 'purpose'
//       vaScore: formData.vaScore,
//       dateOfVA: formData.dateOfVA, // Changed from 'vaDate'
...
//   //     const SA = {
//   //       typeOfAudit: formData.auditType || null,
//   //       auditDate: formData.auditDate ? new Date(formData.auditDate) : null,
//   //       auditingAgency: formData.agency || null,
//   //       certificate: formData.certificate?.name || null,
//   //       sslLabScore: formData.sslLabScore || "",
//   //       tlsNextExpiry: formData.nextExpireDate
//   //         ? new Date(formData.nextExpireDate)
//   //         : null,
//   //       securityAudit: auditRecords.map((record, idx) => ({
//   //         "Sl no": idx + 1,
//   //         Type: record.typeofaudit || record.auditType || null,
//   //         Agency: record.auditingagency || record.agency || null,
//   //       })),
//   //     };
//   //     const TS = {
...
//         securityAudit: auditRecords.map((record, idx) => ({
//           "Sl no": idx + 1,
//           typeOfAudit: record.typeOfAudit, // Changed to match backend
//           auditingAgency: record.auditingAgency, // Changed to match backend
...
//       };
//       const TS = {
//         frontend: usedTech, // Changed from frontEnd to frontend
//         framework: formData.framework,
//         database: usedDb,
//         os: usedOs,
//         osVersion: usedOsVersion, // Include if backend supports
//         repoUrls: usedRepo, // Include if backend supports
//       };
//       const Infra = {
//         typeOfServer: formData.typeOfServer, // Changed from serverType
//         dataCentre: formData.dataCentre,
//         deployment: formData.deployment,
//         location: formData.location,
//         gitUrls: gitUrls,
...
//       if (formData.certificate) {
//         form.append("certificate", formData.certificate); // This will only send the last uploaded file
//       }
