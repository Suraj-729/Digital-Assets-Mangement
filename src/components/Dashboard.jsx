...
// //   const [selectedVariable, setSelectedVariable] = useState("departments"); // which column?
// // const [selectedValue, setSelectedValue] = useState("");                  // chosen value
...
// //         value={selectedValue || selectedVariable}
// //         onChange={(e) => {
// //           const val = e.target.value;
// //           if (["departments", "datacenters", "prismIds"].includes(val)) {
...
// //         <option value="prismIds">Prism IDs</option>

// //         {variableOptions[selectedVariable]?.map((val) => (
...
// //         onClick={() => {
// //           setSelectedVariable("departments");
// //           setSelectedValue("");
// //           setFilter("all");
// //         }}
// //       >
...
// //             <h5 className="card-title mb-3">Profile Info</h5>
// //             <p>
...
// //     </div>
// //   ) : (
// //     <div className="table-vertical-scroll" style={{ marginTop: "50px" }}>
...
//   const [loading, setLoading] = useState(true);
//   const [error, setError] = useState(null);
//   const [filter, setFilter] = useState(""); // Single state for both type and value
//   const [selectedProject, setSelectedProject] = useState(null);
//   const [editProjectData, setEditProjectData] = useState(null);
...
//   try {
//     const response = await api.get(`/dashboard/filter/${type}/${value}`);
//     setFilteredProjects(response.data);
//     console.log(response.data);
    
//   } catch (err) {
//     console.error("Filter fetch error:", err);
//     setFilteredProjects([]); // fallback to empty if API fails
//   }
// };
...
//   // const uniquePrismIds = Array.from(
//   //   new Set(projects.map((p) => p.prismId).filter(Boolean))
//   // );
...
//   projects.forEach((p) => {
//     if (p.deptName && !seen.has(`department:${p.deptName}`)) {
//       seen.add(`department:${p.deptName}`);
//       options.push({ label: `Department: ${p.deptName}`, value: `department:${p.deptName}` });
//     }

//     if (p.prismId && !seen.has(`prismid:${p.prismId}`)) {
//       seen.add(`prismid:${p.prismId}`);
//       options.push({ label: `Prism ID: ${p.prismId}`, value: `prismid:${p.prismId}` });
//     }

//     if (p.dataCentre && !seen.has(`datacenter:${p.dataCentre}`)) {
//       seen.add(`datacenter:${p.dataCentre}`);
//       options.push({ label: `Data Center: ${p.dataCentre}`, value: `datacenter:${p.dataCentre}` });
//     }
//   });
...
//   //         if (type === "department") return project.deptName === value;
//   //         if (type === "prismid") return project.prismId === value;
//   //         if (type === "datacenter") return project.dataCentre === value;
//   //         return true;
//   //       });
