...
const TAB_CONFIG = [
  ...
  { id: "tls", label: "TLS Info", icon: "ssl.png" },
...
const ProjectTabs = () => {
    ...
    async function fetchProjectDetails() {
      try {
        const response = await api.get(
          `/dashboard/projectDetails/${projectName}`
        );
  ...
  return (
    <div
      className={`project-tabs-container form-container ${
    ...
    >
      ...
      {/* Wrap the main content to shift on sidebar toggle */}
      <div
        style={{
          marginLeft: isSidebarOpen ? "250px" : "0", // Adjust to match your sidebar width
        ...
        <div className="tab-content pt-3">
          <AnimatePresence mode="wait">
            ...
            {activeTab === "security" && (
              ...
              >
                <SecurityAudit
                  securityAudits={project?.SA?.securityAudit || []}
                />
              </motion.div>
            )}
            {activeTab === "tech" && (
