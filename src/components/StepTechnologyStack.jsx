          ...
          <div className="col-md-6">
            <div className="input-group">
              ...
              <button
                ...
                type="button"
                onClick={() => addToStack("frontEnd", formData.frontEnd, setUsedTech, "frontEnd")}
              >
                Add
              </button>
            </div>
          ...
          <div className="col-md-6">
            <div className="input-group">
              ...
              <button
                className="btn btn-primary"
                type="button"
                onClick={() => addToStack("framework", formData.framework, setUsedFrameworks, "framework")}
              >
                Add
              </button>
            </div>
          ...
          <div className="col-md-6">
            <div className="input-group">
              ...
              <button
                className="btn btn-primary"
                type="button"
                onClick={() => addToStack("database", formData.database, setUsedDb, "database")}
              >
                Add
              </button>
            </div>
          ...
          <div className="col-md-6">
            <div className="input-group">
              ...
              <button
                className="btn btn-primary"
                type="button"
                onClick={() => addToStack("osVersion", formData.osVersion, setUsedOsVersion, "osVersion")}
              >
                Add
              </button>
            </div>
